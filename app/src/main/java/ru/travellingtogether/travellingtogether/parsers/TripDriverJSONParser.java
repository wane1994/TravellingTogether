...
public class TripDriverJSONParser extends AsyncTask<String,Void,String> {
    public static String jsonResult = null;
    public FragmentPassenger source = null;
    Context context;
    ProgressDialog loading;
    public TripDriverJSONParser(FragmentPassenger fp, Context ctx) {
        source = fp;
        context = ctx;
    }
    ...
    protected void onPostExecute(String jsonResult) {
        loading.dismiss();
        source.driverJSONPE(jsonResult);
    }
}