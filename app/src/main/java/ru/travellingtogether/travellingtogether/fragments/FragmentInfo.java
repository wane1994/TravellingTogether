...
public class FragmentInfo extends android.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView imgLogoInfo = (ImageView) v.findViewById(R.id.imgLogoInfo);
        imgLogoInfo.setImageResource(R.drawable.car);
        return v;
    }
    ...
    public void onResume() {
        super.onResume();
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.appInfo);
    }
